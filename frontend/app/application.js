...
todoApp.config(function ($cryptoProvider, $routeProvider) {
  ...
  $routeProvider.when('/', {
      ...
      resolve: {
          authentication: ['$q', 'AuthenticationService', function($q, AuthenticationService) {
...
todoApp.run(['$rootScope', '$location', 'AuthenticationService', function(rootScope, location, AuthenticationService) {
